...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body results" id="results">
                        ...
                        @if(count($actslots)!=0)
                                                ...
                                                <div class="nt">
                                                    <div class="at_open">
                                                        <h6>
                                                            ...
                                                            <a href="{{ route('showTheSlots',['l_id'=>$l_id,'title'=>$title,'name'=>$name,'as_id'=>$a->id,'date'=>'-']) }}">{{$a->title}}</a>
                                                        </h6>
                                                    </div>
                            ...
                            {{ $actslots->links('pagination::bootstrap-4') }}
                        @endif
                        @if(count($actslots)==0)
    ...
    @include('popup-windows.activitySlot-Delete_Add_Edit')
    <script>
        $(document).ready(function () {
            // Hide the textarea initially
            $('#slotactivities').addClass('active');
        });
