...
<form action="{{url('/exportthemes')}}" method="post" enctype="multipart/form-data" class="col-lg-6" > @csrf @method('GET')
...
<form action="{{ url('/importthemes') }}" method="post" enctype="multipart/form-data" class="col-lg-6" > @csrf @method('GET')
    <hr>
    <span class="info-icon" data-info="Το αρχείο πρέπει να είναι της μορφής .xlsx ή .xls. Στις στύλες ,της πρώτης γραμμής του αρχείου, μπορείτε να γράψετε αντίστοιχα (Τίτλος,Περιγραφή,Αποκλειστικό/Μη αποκλειστικό) για διευκόλυνση. Έπειτα συμπληρώστε τις απαραίτητες πληροφορίες για το κάθε θέμα. (για τη στήλη Αποκλειστικό/Μη αποκλειστικό συμπληρώστε 0 αν δεν είναι απολειστικό και 1 αν είναι αποκλειστικό.)">
                    <ion-icon name="information-circle-outline"></ion-icon>
    </span>
