...
@section('content')
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header" style="display: flex;justify-content: space-between;">
                        <h5>Δραστηριότητα Επιλογής Θεμάτων</h5>
                                                ...
                                                <div class="nt">
                                                    <div class="at_open">
                                                        <h6>
                                                            ...
                                                            <a href="{{ route('showTheThemes',['l_id'=>$l_id,'title'=>$title,'name'=>$name,'ct_id'=>$a->id]) }}">{{$a->title}}</a>
                                                        </h6>
                                                    </div>
    ...
    @include('popup-windows.activityChooseTheme-Delete_Add_Edit')
    <script>
        $(document).ready(function () {
            // Hide the textarea initially
            $('#chooseactivities').addClass('active');
        });
