...
@section('content')
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header" style="display: flex;justify-content: space-between;">
                        <h5>Δραστηριότητα Προσδιορισμός Θεμάτων</h5>
                                                ...
                                                <div class="nt">
                                                    <div class="at_open">
                                                        <h6>
                                                            ...
                                                            <a href="{{ route('showTheJournals',['l_id'=>$l_id,'title'=>$title,'name'=>$name,'dt_id'=>$a->id]) }}">{{$a->title}}</a>
                                                        </h6>
                                                    </div>
    ...
    {{--    Pop up window to delete, edit or add a lesson--}}
        @include('popup-windows.activityDeterminateTheme-Delete_Add_Edit')
    <script>
        $(document).ready(function () {
            // Hide the textarea initially
            $('#determinateactivities').addClass('active');
        });
