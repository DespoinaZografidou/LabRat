...
<div class="modal popup" id="popupdelete">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{url('/deletequiz')}}">
                @csrf @method('GET')
                <div class="modal-body ">
                    <label class="col-md-12 col-form-label" id="text"></label>
                    <input type="text" id="q_id" name="q_id" value="" hidden>
...
<div class="popup modal" id="popupedit">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ url('/createupdatequiz') }}" >
                    @csrf @method('GET')
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="col-form-label text-md-start" for="text">Αριθμός Προσπαθειών</label>
                            <select class="form-control" type="text" id="tries" name="tries" required>
...
<script>
    ...
    $('.button-3 .newactivity').click(function(){
        $("#popupedit").fadeIn();
        document.getElementById("demoModalLabel").textContent = 'Εισαγωγή Νέας Δραστηριότητας Κουίζ';
        ...
        document.getElementById("tries").options[0].text='--Επιλέξτε--';
    ...
    $link.click(function (event) {
        ...
        if (userRole === 'Μαθητής') {
            ...
            var url = "/showTheQuiz/" + encodeURIComponent(l_id) + "/" + encodeURIComponent(title) + "/" + encodeURIComponent(name) + "/" + act_id;
        ...
        if (userRole === 'Καθηγητής' ||userRole === 'Διαχειριστής' ) {
            ...
            if ($button.length) {
                ...
                document.getElementById('q_id').value = myObject.id;
            ...
            document.getElementById("demoModalLabel").textContent = 'Ενημέρωση Δραστηριότητας Κουίζ';
            ...
            document.getElementById("tries").value=myObject.tries;
            document.getElementById("tries").options[0].text=myObject.tries;
