...
<div class="modal popup" id="popupdelete">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{url('/deleteslot')}}">
                @csrf @method('GET')
                <div class="modal-body ">
                    <label class="col-md-12 col-form-label" id="text"></label>
                    <input type="text" id="as_id" name="as_id" value="" hidden>
...
<div class="popup modal" id="popupedit">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ url('/createupdateslot') }}" >
                    @csrf @method('GET')
...
<script>
    ...
    function addNotification(){
        $("#popupedit").fadeIn();
        document.getElementById("demoModalLabel").textContent = 'Εισαγωγή Νέας Δραστηριότητας Slot';
    ...
    $link.click(function (event) {
        ...
        if (userRole === 'Μαθητής') {
            ...
            var title = "{{ $title }}";
            var name = "{{ $name }}";
            var as_id = myObject.id;

            var url = "/showTheSlots/" + encodeURIComponent(l_id) + "/" + encodeURIComponent(title) + "/" + encodeURIComponent(name) + "/" + as_id+"/"+"-";
        ...
        if (userRole === 'Καθηγητής' ||userRole === 'Διαχειριστής' ) {
            ...
            if ($button.length) {
                ...
                document.getElementById('as_id').value = myObject.id;
            ...
            document.getElementById("demoModalLabel").textContent = 'Ενημέρωση Δραστηριότητας Slot';
