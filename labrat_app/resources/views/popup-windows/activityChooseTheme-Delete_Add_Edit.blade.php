...
<div class="modal popup" id="popupdelete">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{url('/deletechoosetheme')}}">
                @csrf @method('GET')
                <div class="modal-body ">
                    <label class="col-md-12 col-form-label" id="text"></label>
                    <input type="text" id="ct_id" name="ct_id" value="" hidden>
...
<div class="popup modal" id="popupedit">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ url('/createupdatechoosetheme') }}" >
                    @csrf @method('GET')
...
<script>
    ...
    $('.button-3').click(function(){
        $("#popupedit").fadeIn();
        document.getElementById("demoModalLabel").textContent = 'Εισαγωγή Νέας Δραστηριότητας Επιλογής Θεμάτων';
    ...
    $link.click(function (event) {
        ...
        if (userRole === 'Μαθητής') {
            ...
            var title = "{{ $title }}";
            var name = "{{ $name }}";
            var ct_id = myObject.id;

            var url = "/showTheThemes/" + encodeURIComponent(l_id) + "/" + encodeURIComponent(title) + "/" + encodeURIComponent(name) + "/" + ct_id;
        ...
        if (userRole === 'Καθηγητής' ||userRole === 'Διαχειριστής' ) {
            ...
            if ($button.length) {
                ...
                document.getElementById('ct_id').value = myObject.id;
            ...
            document.getElementById("demoModalLabel").textContent = 'Ενημέρωση Δραστηριότητας Επιλογής Θεμάτων';
